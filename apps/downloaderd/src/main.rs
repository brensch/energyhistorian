...
#[derive(Debug, Parser)]
#[command(author, version, about = "energyhistorian downloader service")]
struct Args {
    ...
    #[arg(long, env = "CLAIM_BATCH_SIZE", default_value_t = 25)]
    ...
    tracing_subscriber::fmt()
        .with_env_filter(
            EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| EnvFilter::new("info,downloaderd=info")),
        )
        .init();
}
