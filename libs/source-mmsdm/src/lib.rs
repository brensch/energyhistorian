...
const LOGICAL_SOURCE_FAMILY: &str = "mmsdm";
...
impl MmsdmPlugin {
    ...
    pub async fn discover_collection(
        ...
        discover_public_reference_data(client, ctx).await
    }
...
impl SourcePlugin for MmsdmPlugin {
    fn descriptor(&self) -> SourceDescriptor {
        SourceDescriptor {
            source_id: "aemo.mmsdm".to_string(),
            ...
            for href in hrefs {
                ...
                artifacts.push(DiscoveredArtifact {
                    metadata: ArtifactMetadata {
                        ...
                        source_id: LOGICAL_SOURCE_FAMILY.to_string(),
                        acquisition_uri,
