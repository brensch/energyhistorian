        # What is the daytime (9am-5pm) vs nighttime (5pm-9am) average price by region?
        ...
        Top row: REGIONID=NSW1, period_bucket=Daytime, avg_price_mwh=40.59. Returned 5 rows. The mean of `avg_price_mwh` across the result set is 20.610.
