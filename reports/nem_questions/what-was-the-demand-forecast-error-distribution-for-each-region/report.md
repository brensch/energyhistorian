        # What was the demand forecast error distribution for each region?
        ...
        Top row: REGIONID=NSW1, forecast_error_mw=6643.8. Returned 14,550 rows. The mean of `forecast_error_mw` across the result set is 4259.705.
