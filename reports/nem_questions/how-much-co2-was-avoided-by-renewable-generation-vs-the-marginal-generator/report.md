# How much CO2 was avoided by renewable generation vs the marginal generator?
...
The semantic layer does not yet expose a defensible marginal-generator carbon counterfactual. Results are generated from the current semantic layer in ClickHouse. If the warehouse does not yet contain full market history, the answer reflects the available window rather than authoritative all-time history.
