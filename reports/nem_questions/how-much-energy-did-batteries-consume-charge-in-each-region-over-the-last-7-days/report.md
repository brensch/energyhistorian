        # How much energy did batteries consume (charge) in each region over the last 7 days?
        ...
        Top row: REGIONID=VIC1, charge_mwh=23135.39. Returned 4 rows. The mean of `charge_mwh` across the result set is 17540.552.
