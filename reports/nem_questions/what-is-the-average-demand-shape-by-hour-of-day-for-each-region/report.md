        # What is the average demand shape by hour of day for each region?
        ...
        Top row: hour_of_day=0, REGIONID=NSW1, avg_demand_mw=7313.71. Returned 120 rows. The mean of `hour_of_day` across the result set is 11.500.
