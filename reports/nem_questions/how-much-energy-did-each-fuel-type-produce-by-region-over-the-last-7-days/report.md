        # How much energy did each fuel type produce by region over the last 7 days?
        ...
        Top row: REGIONID=NSW1, FUEL_TYPE=Wind, energy_mwh=89242.33. Returned 16 rows. The mean of `energy_mwh` across the result set is 48101.764.
