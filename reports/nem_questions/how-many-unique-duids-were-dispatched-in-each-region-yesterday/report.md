        # How many unique DUIDs were dispatched in each region yesterday?
        ...
        Top row: REGIONID=QLD1, dispatched_duids=90. Returned 5 rows. The mean of `dispatched_duids` across the result set is 64.000.
