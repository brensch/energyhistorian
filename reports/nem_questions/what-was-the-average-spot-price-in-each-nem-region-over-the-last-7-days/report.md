        # What was the average spot price in each NEM region over the last 7 days?
        ...
        Top row: REGIONID=TAS1, avg_spot_price_mwh=84.18. Returned 5 rows. The mean of `avg_spot_price_mwh` across the result set is 53.858.
