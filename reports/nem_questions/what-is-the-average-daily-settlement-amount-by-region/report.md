        # What is the average daily settlement amount by region?
        ...
        Top row: REGIONID=NSW1, avg_daily_settlement_proxy=13528395.63. Returned 5 rows. The mean of `avg_daily_settlement_proxy` across the result set is 6245071.386.
