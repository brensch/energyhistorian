        # What is the net export position of each region by hour?
        ...
        Top row: hour_start=2026-03-02 04:00:00, REGIONID=NSW1, avg_net_interchange_mw=-939.8. Returned 1,220 rows. The mean of `avg_net_interchange_mw` across the result set is 18.784.
