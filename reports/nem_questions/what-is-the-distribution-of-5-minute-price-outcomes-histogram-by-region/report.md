        # What is the distribution of 5-minute price outcomes (histogram) by region?
        ...
        Top row: REGIONID=NSW1, price_bucket=7, interval_count=23. Returned 9 rows. The mean of `price_bucket` across the result set is 7.222.
