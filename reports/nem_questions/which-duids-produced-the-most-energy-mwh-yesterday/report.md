        # Which DUIDs produced the most energy (MWh) yesterday?
        ...
        Top row: DUID=WAUBRAWF, REGIONID=VIC1, FUEL_TYPE=Wind, energy_mwh=31871.86. Returned 20 rows. The mean of `energy_mwh` across the result set is 7157.402.
