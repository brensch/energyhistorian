        # Which region is most dependent on interconnector imports?
        ...
        Top row: REGIONID=SA1, import_dependency_proxy=0.2961. Returned 5 rows. The mean of `import_dependency_proxy` across the result set is 0.138.
